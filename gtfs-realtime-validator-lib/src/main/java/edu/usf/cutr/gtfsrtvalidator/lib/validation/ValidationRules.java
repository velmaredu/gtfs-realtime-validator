...
public class ValidationRules {
    ...
    public static final ValidationRule W003 = new ValidationRule("W003", "WARNING",
            "ID in one feed missing from the other",
    ...
    public static final ValidationRule W004 = new ValidationRule("W004", "WARNING", "vehicle speed is unrealistic",
            ...
            "is unrealistic");
    public static final ValidationRule W005 = new ValidationRule("W005", "WARNING",
            "Missing vehicle_id for frequency-based exact_times = 0",
    ...
    public static final ValidationRule W007 = new ValidationRule("W007", "WARNING",
            "Refresh interval is more than 35 seconds",
    ...
    public static final ValidationRule W008 = new ValidationRule("W008", "WARNING",
            "Header timestamp is older than 65 seconds",
            "The data in a GTFS-realtime feed should always be less than one minute old",
            "old which is greater than the recommended age of 65 seconds");
    public static final ValidationRule W009 = new ValidationRule("W009", "WARNING",
            "schedule_relationship not populated",
    ...
    public static final ValidationRule E002 = new ValidationRule("E002", "ERROR",
            "stop_times_updates not strictly sorted",
    ...
    public static final ValidationRule E003 = new ValidationRule("E003", "ERROR",
            "GTFS-rt trip_id does not exist in GTFS data and does not have schedule_relationship of ADDED",
    ...
    public static final ValidationRule E004 = new ValidationRule("E004", "ERROR",
            "GTFS-rt route_id does not exist in GTFS data",
            "All route_ids provided in the GTFS-rt feed must exist in the GTFS data",
            "does not exist in the GTFS data routes.txt");

    // TODO - implement - see
    // https://github.com/CUTR-at-USF/gtfs-realtime-validator/issues/155
    public static final ValidationRule E005 = new ValidationRule("E005", "ERROR",
            "stop_time_update contains only delay (no times) and GTFS stop_times.txt does not contain corresponding arrival and/or departure_time for that stop",
    ...
    public static final ValidationRule E006 = new ValidationRule("E006", "ERROR",
            "Missing required trip field for frequency-based exact_times = 0",
    ...
    // TODO - implement - see
    // https://github.com/CUTR-at-USF/gtfs-realtime-validator/issues/156
    public static final ValidationRule E007 = new ValidationRule("E007", "ERROR",
            "Trips with same vehicle_id are not in the same block",
    ...
    // TODO - implement - see
    // https://github.com/CUTR-at-USF/gtfs-realtime-validator/issues/157
    ...
    public static final ValidationRule E009 = new ValidationRule("E009", "ERROR",
            "GTFS-rt stop_sequence isn't provided for trip that visits same stop_id more than once",
    ...
    public static final ValidationRule E010 = new ValidationRule("E010", "ERROR",
            "location_type not 0 in stops.txt",
    ...
    public static final ValidationRule E011 = new ValidationRule("E011", "ERROR",
            "GTFS-rt stop_id does not exist in GTFS data",
            "All stop_ids referenced in GTFS-rt feeds must exist in GTFS stops.txt",
            "does not exist in GTFS data stops.txt");

    public static final ValidationRule E012 = new ValidationRule("E012", "ERROR",
            "Header timestamp should be greater than or equal to all other timestamps",
    ...
    public static final ValidationRule E013 = new ValidationRule("E013", "ERROR",
            "Frequency type 0 trip schedule_relationship should be UNSCHEDULED or empty",
    ...
    // TODO - implement - see
    // https://github.com/CUTR-at-USF/gtfs-realtime-validator/issues/158
    public static final ValidationRule E014 = new ValidationRule("E014", "ERROR",
            "Predictions for trips are out-of-order in the block",
    ...
    public static final ValidationRule E015 = new ValidationRule("E015", "ERROR",
            "All stop_ids referenced in GTFS-rt TripUpdates and VehiclePositions feeds must have the location_type = 0",
    ...
    public static final ValidationRule E016 = new ValidationRule("E016", "ERROR",
            "trip_ids with schedule_relationship ADDED must not be in GTFS data",
    ...
    public static final ValidationRule E017 = new ValidationRule("E017", "ERROR",
            "GTFS-rt content changed but has the same header timestamp",
    ...
    public static final ValidationRule E018 = new ValidationRule("E018", "ERROR",
            "GTFS-rt header timestamp decreased between two sequential iterations",
    ...
    public static final ValidationRule E019 = new ValidationRule("E019", "ERROR",
            "GTFS-rt frequency type 1 trip start_time must be a multiple of GTFS headway_secs later than GTFS start_time",
    ...
    public static final ValidationRule E022 = new ValidationRule("E022", "ERROR",
            "Sequential stop_time_update times are not increasing",
            "stop_time_update arrival/departure times between sequential stops should always increase - they should never be the same or decrease.",
            "- times must increase between two sequential stops");

    public static final ValidationRule E023 = new ValidationRule("E023", "ERROR",
            "trip start_time does not match first GTFS arrival_time",
    ...
    public static final ValidationRule E024 = new ValidationRule("E024", "ERROR",
            "trip direction_id does not match GTFS data",
            "GTFS-rt trip direction_id must match the direction_id in GTFS trips.txt",
            "- direction_id does not match");

    public static final ValidationRule E025 = new ValidationRule("E025", "ERROR",
            "stop_time_update departure time is before arrival time",
    ...
    public static final ValidationRule E028 = new ValidationRule("E028", "ERROR",
            "Vehicle position outside agency coverage area",
            "The vehicle position should be inside the agency coverage area.  This is defined as within roughly 1/8 of a mile (200 meters) of the GTFS shapes.txt data, or stops.txt locations if the GTFS feed doesn't include shapes.txt.",
            "- vehicle should be within area");

    public static final ValidationRule E029 = new ValidationRule("E029", "ERROR",
            "Vehicle position far from trip shape",
            "The vehicle position should be within a certain distance of the GTFS shapes.txt data for the current trip unless there is a Service Alert with the Effect of DETOUR for this trip_id.",
            "- vehicle should be near trip shape or on DETOUR");

    public static final ValidationRule E030 = new ValidationRule("E030", "ERROR",
            "GTFS-rt alert trip_id does not belong to GTFS-rt alert route_id in GTFS trips.txt",
    ...
    public static final ValidationRule E031 = new ValidationRule("E031", "ERROR",
            "Alert informed_entity.route_id does not match informed_entity.trip.route_id",
    ...
    public static final ValidationRule E032 = new ValidationRule("E032", "ERROR",
    ...
    public static final ValidationRule E033 = new ValidationRule("E033", "ERROR",
            "Alert informed_entity does not have any specifiers",
    ...
    public static final ValidationRule E034 = new ValidationRule("E034", "ERROR",
            "GTFS-rt agency_id does not exist in GTFS data",
    ...
    public static final ValidationRule E035 = new ValidationRule("E035", "ERROR",
            "GTFS-rt trip.trip_id does not belong to GTFS-rt trip.route_id in GTFS trips.txt",
            "The GTFS-rt trip.trip_id should belong to the specified trip.route_id in GTFS trips.txt",
            "in GTFS trips.txt");

    public static final ValidationRule E036 = new ValidationRule("E036", "ERROR",
            "Sequential stop_time_updates have the same stop_sequence",
    ...
    public static final ValidationRule E037 = new ValidationRule("E037", "ERROR",
            "Sequential stop_time_updates have the same stop_id",
            "Sequential GTFS-rt trip stop_time_updates shouldn't have the same stop_id",
            "- sequential stop_ids should be different");

    public static final ValidationRule E038 = new ValidationRule("E038", "ERROR",
            "Invalid header.gtfs_realtime_version",
            "header.gtfs_realtime_version should be a valid value",
            "is invalid");

    public static final ValidationRule E039 = new ValidationRule("E039", "ERROR",
    ...
    public static final ValidationRule E040 = new ValidationRule("E040", "ERROR",
            "stop_time_update doesn't contain stop_id or stop_sequence",
    ...
    public static final ValidationRule E041 = new ValidationRule("E041", "ERROR",
            "trip doesn't have any stop_time_updates",
    ...
    public static final ValidationRule E042 = new ValidationRule("E042", "ERROR",
            "arrival or departure provided for NO_DATA stop_time_update",
    ...
    public static final ValidationRule E043 = new ValidationRule("E043", "ERROR",
            "stop_time_update doesn't have arrival or departure",
            "If a stop_time_update doesn't have a schedule_relationship of SKIPPED or NO_DATA, then either arrival or departure must be provided",
            "doesn't have arrival or departure");

    public static final ValidationRule E044 = new ValidationRule("E044", "ERROR",
            "stop_time_update arrival/departure doesn't have delay or time",
    ...
    public static final ValidationRule E045 = new ValidationRule("E045", "ERROR",
            "GTFS-rt stop_time_update stop_sequence and stop_id do not match GTFS",
            "If GTFS-rt stop_time_update contains both stop_sequence and stop_id, the values must match the GTFS data in stop_times.txt",
            "- stop_ids should be the same");

    public static final ValidationRule E046 = new ValidationRule("E046", "ERROR",
            "GTFS-rt stop_time_update without time doesn't have arrival/departure_time in GTFS",
            "If only delay is provided in a stop_time_update arrival or departure (and not a time), then the GTFS stop_times.txt must contain arrival_times and/or departure_times for these corresponding stops.",
            "isn't set and GTFS doesn't have arrival/departure_time in stop_times.txt");

    public static final ValidationRule E047 = new ValidationRule("E047", "ERROR",
            "VehiclePosition and TripUpdate ID pairing mismatch",
    ...
    public static final ValidationRule E049 = new ValidationRule("E049", "ERROR",
            "header incrementality not populated",
    ...
    public static final ValidationRule E051 = new ValidationRule("E051", "ERROR",
            "GTFS-rt stop_sequence not found in GTFS data",
    ...
    public static synchronized List<ValidationRule> getRules() {
        if (mAllRules.isEmpty()) {
            ...
            for (Field field : fields) {
                if (Modifier.isStatic(field.getModifiers())) {
                    Class<ValidationRule> classType = ValidationRule.class;
                    if (field.getType() == classType) {
        ...
        // Return a read-only list of these rules so different threads can't modify the
        // list
